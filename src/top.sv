...
logic [6:0] FpgaPins_Fpga_PIPE_segments_n_a2,
            FpgaPins_Fpga_PIPE_segments_n_a3;

// For /fpga_pins/fpga|pipe$sseg_out.
logic [7:0] FpgaPins_Fpga_PIPE_sseg_out_a1;
...
logic [18:0] FpgaPins_Fpga_PIPE_Keypad_Seq_n1,
...
// For /fpga_pins/fpga|pipe/keypad$sample_row_mask.
logic [3:0] FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a0,
            FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a1;
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $segments_n.
            always_ff @(posedge clk) FpgaPins_Fpga_PIPE_segments_n_a3[6:0] <= FpgaPins_Fpga_PIPE_segments_n_a2[6:0];
            ...
            //
               ...
               // Staging of $Seq.
               always_ff @(posedge clk) FpgaPins_Fpga_PIPE_Keypad_Seq_a0[18:0] <= FpgaPins_Fpga_PIPE_Keypad_Seq_n1[18:0];
               ...
               always_ff @(posedge clk) FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a1[3:0] <= FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a0[3:0];
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_pipe
               ...
               (* keep *) logic [7:0] \///@1$sseg_out ;
               assign \///@1$sseg_out = FpgaPins_Fpga_PIPE_sseg_out_a1;
               ...
               if (1) begin : \/keypad 
                  ...
                  assign \////@0$sample_row_mask = FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a0;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 286 as: m5+board(/top, /fpga, 7, $, , my_design)
      ...
      //_/fpga_pins
         ...
         //_/fpga
            //_\source top.tlv 179   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+my_design.
               //_|pipe
                  //_@-1
                     assign FpgaPins_Fpga_PIPE_reset_n1 = reset || ui_in[7];
            
                  //_\source top.tlv 69   // Instantiated from top.tlv, 184 as: m5+PmodKYPD(|pipe, /keypad, @0, $ui_in[3:0], 1'b1, ⌈left: 40, top: 80, width: 20, height: 20⌉)
                     //_/keypad
                        ...
                        //_@0
                           ...
                           assign FpgaPins_Fpga_PIPE_Keypad_Seq_n1[18:0] =
                              FpgaPins_Fpga_PIPE_Keypad_reset_a0 ? 0 : FpgaPins_Fpga_PIPE_Keypad_Seq_a0 + 1;
                           assign FpgaPins_Fpga_PIPE_Keypad_sampling_a0 = FpgaPins_Fpga_PIPE_Keypad_Seq_a0[16:13] == 4'b0;
                           assign FpgaPins_Fpga_PIPE_Keypad_sample_a0 = FpgaPins_Fpga_PIPE_Keypad_sampling_a0 && (FpgaPins_Fpga_PIPE_Keypad_Seq_a0[12:0] == ~13'b0);
                  
                           // Update column keypad input.
                           //_?$sampling
                              assign FpgaPins_Fpga_PIPE_Keypad_row_sel_a0[1:0] = FpgaPins_Fpga_PIPE_Keypad_Seq_a0[18:17];
                           assign FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a0[3:0] = 4'b1 << FpgaPins_Fpga_PIPE_Keypad_row_sel_a0;
                        //_@1
                           //_?$sample
                  ...
                  //_@2
                     //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 844   // Instantiated from top.tlv, 187 as: m5+sseg_decoder($segments_n, /keypad$digit_pressed)
                        assign FpgaPins_Fpga_PIPE_segments_n_a2[6:0] =
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 0) ? 7'b1000000 : // '0'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 1) ? 7'b1111001 : // '1'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 2) ? 7'b0100100 : // '2'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 3) ? 7'b0110000 : // '3'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 4) ? 7'b0011001 : // '4'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 5) ? 7'b0010010 : // '5'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 6) ? 7'b0000010 : // '6'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 7) ? 7'b1111000 : // '7'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 8) ? 7'b0000000 : // '8'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 9) ? 7'b0010000 : // '9'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 10) ? 7'b0001000 : // 'a'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 11) ? 7'b0000011 : // 'b'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 12) ? 7'b1000110 : // 'c'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 13) ? 7'b0100001 : // 'd'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 14) ? 7'b0000110 : // 'e'
                             (FpgaPins_Fpga_PIPE_Keypad_digit_pressed_a2 == 15) ? 7'b0001110 : // 'f'
                             7'b1111111 ;                // 'nothing'
                     //_\end_source
                  //_@1
                     // Re-align output for 7-seg to combine with keypad input.
                     assign FpgaPins_Fpga_PIPE_sseg_out_a1[7:0] = {1'b0, ~ FpgaPins_Fpga_PIPE_segments_n_a3};
                     // Drive to PmodKYPD if sampling, otherwise, drive for 7-seg display.
                     assign uo_out = FpgaPins_Fpga_PIPE_Keypad_sampling_a1 ? {4'b0, FpgaPins_Fpga_PIPE_Keypad_sample_row_mask_a1} : FpgaPins_Fpga_PIPE_sseg_out_a1;
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 288 as: m5+tt_input_labels_viz(⌈"KYPD row0", "KYPD row1", "KYPD row2", "KYPD row3", "D:Mask", "D:High/Dbg", "D:Reported", "Reset"⌉)
